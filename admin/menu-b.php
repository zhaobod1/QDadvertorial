...
//-->
        ...
        <table width="150" border="0" cellpadding="0" cellspacing="2" class="md" bgcolor="#FFFFFF">
          ...
          <tr>
            <td background="images/menubg.gif" height="26"><div align="center"><a onclick="javascript:ShowFLT(2)" href="javascript:void(null)">栏目优化</a></div></td>
          </tr>
          <tr id="LM2" style="DISPLAY: none">
            <td bgcolor="#FFFFFF"><table cellspacing="0" cellpadding="0" width="100%" border="0">
              <tr>
                <td width="29%" height="20"><div align="center"><img src="images/bullet.gif" width="15" height="15" border="0" /></div></td>
                <td width="71%" height="20" class="p1"><div align="left"><a href="manage_seo.php?ID=1" target="main">新闻中心栏目</a></div></td>
              </tr>
              <tr>
                <td height="20"><div align="center"><img src="images/bullet.gif" width="15" height="15" border="0" /></div></td>
                <td height="20" class="p1"><div align="left"><a href="manage_seo.php?ID=2" target="main">行业知识栏目</a></div></td>
              </tr>
			  <tr>
                <td height="20"><div align="center"><img src="images/bullet.gif" width="15" height="15" border="0" /></div></td>
                <td height="20" class="p1"><div align="left"><a href="manage_seo.php?ID=3" target="main">产品中心栏目</a></div></td>
              </tr>
              <tr>
                <td width="29%" height="20"><div align="center"><img src="images/bullet.gif" width="15" height="15" border="0" /></div></td>
                <td width="71%" height="20" class="p1"><div align="left"><a href="manage_seo.php?ID=4" target="main">公司简介栏目</a></div></td>
              </tr>
              <tr>
                <td height="20"><div align="center"><img src="images/bullet.gif" width="15" height="15" border="0" /></div></td>
                <td height="20" class="p1"><div align="left"><a href="manage_seo.php?ID=5" target="main">联系我们栏目</a></div></td>
              </tr>
			  <tr>
                <td height="20"><div align="center"><img src="images/bullet.gif" width="15" height="15" border="0" /></div></td>
                <td height="20" class="p1"><div align="left"><a href="manage_seo.php?ID=6" target="main">烟道机栏目</a></div></td>
              </tr>
            </table></td>
          </tr>
          <tr>
		  ...
		  <tr>
            <td background="images/menubg.gif" height="26"><div align="center"><a onclick="javascript:ShowFLT(7)" href="javascript:void(null)">网站单页管理</a> </div></td>
          </tr>
          <tr id="LM7" style="DISPLAY: none">
            <td bgcolor="#FFFFFF"><table cellspacing="0" cellpadding="0" width="100%" border="0">
              ...
              <tr>
                <td height="20"><div align="center"><img src="images/bullet.gif" width="15" height="15" border="0" /></div></td>
                <td height="20" class="p1"><div align="left"><a href="manageabout.php?titleID=aboutydj" target="main">烟道机</a></div></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td background="images/menubg.gif" height="26"><div align="center"><a onclick="javascript:ShowFLT(6)" href="javascript:void(null)">首页轮播设置</a> </div></td>
          </tr>
		  ...
		  <tr>
            <td background="images/menubg.gif" height="26"><div align="center"><a onclick="javascript:ShowFLT(9)" href="javascript:void(null)">友情链接管理</a> </div></td>
          </tr>
          ...
          <tr>
            <td background="images/menubg.gif" height="26"><div align="center"><a onclick="javascript:ShowFLT(8)" href="javascript:void(null)">数据库管理</a> </div></td>
          </tr>
