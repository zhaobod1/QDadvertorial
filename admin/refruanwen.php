...
<div id="main_frameid" class="pad-10 display" style="_margin-right:-12px;_width:98.9%;">
	<div class="col-2  col-auto">
		...
		<div class="content">
			<form id="form1" name="form1" method="post" action="saveruanwen.php?action=ref" onsubmit="return check()"
			      style="display:">
				<table width="100%" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" id='step2'>
					...
					<tr>
						...
						<td align="left" bgcolor="#FFFFFF" style="padding:10px;">
							<?php
							$prefix = substr($rsN["content"], 0, 10);
							if ($prefix == 'huo15com->') {

								$rsN["content"] = substr($rsN["content"], 10);
								?>
								<style>
									.btn {
							...
							<textarea name="neirong"
						                                                                   style="width:100%;height:330px;"><?php echo htmlspecialchars($rsN["content"]); ?></textarea>
							<input type="submit" name="button" id="buttonsave" value=" 提 交 "
							       style="width:60px; height:25px;display:none"/></td>
					</tr>
					<tr>
						<td height="30" bgcolor="#FFFFFF">
							<div align="center">金 额</div>
						</td>
						<td align="left" bgcolor="#FFFFFF" style="padding-left:10px;"><font
								color="#FF0000"><b><?php echo $rsN[price]; ?></b></font>元<input id="price"
						                                                                        value="<?php echo $rsN["price"]; ?>"
						                                                                        type="hidden"
						                                                                        name="price"/>
					...
					<tr>
						...
						<td align="left" bgcolor="#FFFFFF" style="padding:10px;"><SELECT id="flag"
						                                                                 onchange=setprice(this.value)
						                                                                 name="flag">
								<OPTION value=3 <?php echo "selected"; ?>>已拒稿</OPTION>
							</SELECT></td>
					</tr>
					<tr>
						<td height="30" bgcolor="#FFFFFF">
							<div align="center">拒稿原因</div>
						</td>
						<td align="left" bgcolor="#FFFFFF" style="padding:10px;"><TEXTAREA rows="3" cols="87"
						                                                                   id="reason"
						                                                                   name="reason"><?php echo htmlspecialchars($rsN["reason"]); ?></TEXTAREA>
						</td>
					</tr>
				</table>
				<div align="center"><input name="totalmoney" type="hidden" id="totalmoney" style="border:0px;" value="0"
				                           readonly="readonly"/> <input type="hidden" id='yixuanhidden'
				                                                        name='yixuanhidden'/>
					<!--input type="button" value="下一步 选择媒体" onclick="nextpage()" style="width:130px; height:30px;text-align:center;  margin-top:10px; "/><input type="button" value="上一步 选择媒体" onclick="perpage()" style="width:130px;height:30px; text-align:center;margin-top:3px;"/--><input
						type="button" value=" 确 认 " onclick="$('#buttonsave').click()"
						style="width:80px;height:30px; text-align:center;margin-top:3px;"/></div>
			</form>
			<br/>
					...
					<tr>
						<td bgcolor="#FFFFFF" style="padding-left:5px;">
							<ul class='meitilist'>
								...
								<li onclick="mt_search1(30)" style=' cursor:pointer;'>工业贸易</li>
							</ul>
							...
							<ul class='meitilist'>
								...
								<li onclick="mt_search7('新浪网')" style=' cursor:pointer;'>新浪网</li>
							</ul>
							<div style="clear:both;"></div>
							<ul class='meitilist'>
								...
								<li onclick="mt_search2(3)" style=' cursor:pointer;'>120元以上</li>
							</ul>
							<div style="clear:both;"></div>
							<ul class='meitilist'>
								...
								<li onclick="mt_search6('其他地区')" style=' cursor:pointer;'>其他地区</li>
							</ul>
							<div style="clear:both;"></div>
							<ul class='meitilist'>
								<li onclick="mt_search3()" style=' cursor:pointer;'>新闻源-》</li>
								<li onclick="mt_search4('百度新闻源')" style=' cursor:pointer;'>百度新闻源</li>
								<li onclick="mt_search4('无')" style=' cursor:pointer;'>非新闻源</li>
							</ul>
							<div style="clear:both;"></div>
							<ul class='meitilist'>
								...
								<li onclick="mt_search5('不能带网址')" style=' cursor:pointer;'>不能带网址</li>
							</ul>
							<div style="clear:both;"></div>
						</td>
					</tr>
						...
						<tr>
							...
							<td width="94%" align="center" valign="middle" bgcolor="#FFFFFF">
								<table border="0" cellpadding="5" cellspacing="2">
									<tr>
										<td>
											<div align="center">自定义搜索：媒体名称</div>
										</td>
										<td><input name="meiti_name" type="text" class="txt" id="meiti_name"
