...
<table style="MARGIN-TOP: 5px; BORDER-COLLAPSE: collapse; MARGIN-BOTTOM: 5px; HEIGHT: 35px" border=1 cellSpacing=1 borderColor=#c9d3e9 cellPadding=0 width="98%" align=center>
  <tr>
    <td width="100%" height="28" align="center" background="skin/images/frame/wbg.gif" class='title'>&nbsp;<strong>添加信息类型</strong></td>
  </tr>
  <tr>
    <td height="49" bgcolor="#FFFFFF"><form id="myform2" name="myform2" method="post" action="saveclass.php?action=add&amp;titleID=<?php echo $titleID;?>" onsubmit="return CheckForm2();">
      <table class="tableBorder" width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF">
        <tr align="center" bgcolor="#F8F8F8" >
          <td width="27%" bgcolor="#F8F8F8">栏目名称</td>
		  <td width="27%" bgcolor="#F8F8F8">栏目别名</td>
        ...
        <tr align="center" bgcolor="#F8F8F8" >
		  ...
		  <td bgcolor="#FFFFFF"><input name="enBigClass1" type="text" id="enBigClass1" size="16" /></td>
...
<table border=0 cellSpacing=0 cellPadding=0 width="98%" align=center style="font-size:12px">
  <tr>
    <td height="49" bgcolor="#FFFFFF"><table width="100%" height="49" border="0" cellpadding="0" cellspacing="1">
      <tr>
        <td bgColor=#FFFFFF colSpan=5 align=middle><?php
		...
		?>
              <table style="BORDER-COLLAPSE: collapse" border=1 cellSpacing=0 borderColor=#c9d3e9 cellPadding=0 width="100%" align=center style="font-size:12px">
                <tr align="center" height=25 bgColor=#e3e8f3>
				  ...
				  <td width="23%" align="center">栏目别名</td>
                  <td width="19%" align="center">导航排序</td>
			  ...
			  {
			  ?>
                <form id="myform" name="myform" method="post" action="saveclass.php?action=edit&amp;titleID=<?php echo $titleID;?>&amp;ID=<?php echo $rs["ID"]?>" onsubmit="return CheckForm();">
                  <tr align="center" onmouseover="this.bgColor='#FBDFCC';" onmouseout="this.bgColor='#FFFFFF';" height=25>
					...
					<td><input name="enBigClass" type="text" id="enBigClass" value="<?php echo $rs["enBigClass"];?>" size="16" /></td>
                    <td width="19%" align="center"><input name="classidorder" type="text" id="classidorder" value="<?php echo $rs["paixu"];?>" size="4" /></td>
                    <td width="19%" align="center"><DIV class="alink" align=center>
					  <input type="submit" name="Submit" value="修改"/>
                      <a href="saveclass.php?action=del&amp;titleID=<?php echo $titleID;?>&amp;ID=<?php echo $rs["ID"]?>">删除</a> <a href="manage_seo.php?ID=<?php echo $rs["ID"]?>">设置</a></div></td>
                  </tr>
                </form>
                <?php
				$i++;
