...
<div class="header">
	...
	<div class="container blue">
		<div class="title">支付宝充值-软文直通车</div>
	</div>
</div>
<div class="content">
	<form action="alipayapi.php" class="alipayform" method="post" target="_blank">
		<div class="element" style="margin-top:60px;">
			<div class="legend">软文直通车充值系统 </div>
		</div>
		<div class="element">
			<div class="etitle">用&nbsp;&nbsp;户&nbsp;&nbsp;名:</div>
			<div class="einput"><input type="text" value="<?php echo @$_COOKIE["VipUser"]; ?>" readonly="readonly" style="background: #EEEEEE;" name="user_name" id="user_name"></div>
			<br>
			<div class="mark hide">注意：商户订单号(out_trade_no).必填(建议是英文字母和数字,不能含有特殊字符)</div>
		</div>
		<div class="element hide">
			<div class="etitle">商户订单号:</div>
			<div class="einput"><input type="text" value="<?php echo $order_id; ?>" readonly="readonly" style="background: #EEEEEE;" name="WIDout_trade_no" id="out_trade_no"></div>
			<br>
			<div class="mark hide">注意：商户订单号(out_trade_no).必填(建议是英文字母和数字,不能含有特殊字符)</div>
		</div>
		...
		<div class="element hide">
			...
			<div class="einput"><input type="text" readonly="readonly" style="background: #EEEEEE;" name="WIDsubject" value="软文直通车充值"></div>
			<br>
			<div class="mark hide">注意：产品名称(subject)，必填(建议中文，英文，数字，不能含有特殊字符)</div>
		</div>
		<div class="element">
			<div class="etitle">付款金额:</div>
			<div class="einput"><input type="text" placeholder="请输入金额，例如输入100" name="WIDtotal_fee" value=""></div>
			<br>
			<div class="mark">注意：付款金额，必填(格式如：1.00,请精确到分)</div>
		</div>
		<div class="element hide">
			<div class="etitle">商品描述:</div>
			<div class="einput"><input readonly="readonly" style="background: #EEEEEE;" type="text" name="WIDbody" value="软文直通车充值"></div>
			<br>
			<div class="mark hide">注意：商品描述(body)，选填(建议中文，英文，数字，不能含有特殊字符)</div>
		</div>
		<div class="element" style="margin: 0; text-align: center">
...
<script>
	...
	out_trade_no.value = "<?php echo $order_id; ?>";
</script>
