...
<div id="main_frameid" class="pad-10 display" style="_margin-right:-12px;_width:98.9%;">
  <div class="col-2  col-auto" >
    ...
    <div class="content">
      <form id="form1" name="form1" method="post" action="savemedia.php?action=save" onsubmit="return check()" style="display:" >
        <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" id='step2'>
          <tr>
              <td><input type="submit" name="button" id="buttonsave" value=" 提 交 "  style="width:60px; height:25px;display:none" /></td>
          </tr>
        </table>
		<div align="center"><!--input name="totalmoney" type="text" id="totalmoney" style="border:0px;" value="0" readonly="readonly"/--><INPUT id="userid" value="<?php echo $ID;?>" type="hidden" name="userid"><input type="hidden" id='yixuanhidden' name='yixuanhidden'/><!--input type="button" value=" 提 交 " onclick="$('#buttonsave').click()"  style="width:80px;height:30px; text-align:center;margin-top:3px;"/--></div>
      </form>
      <br />
      <div id="flselect" style="display:">
        ...
        <div id='yixuan' class="nextpage"> &nbsp;已选媒体: <span id="yixuantr"></span>
...
function sel(id,tr,jg,yue){
	...
	if($("#xz_"+id).attr("checked")==false) {
		...
		$("#yixuan").show();
		if( yx.indexOf(tr)==-1 ) {
			$("#yixuanhidden").val(s2+","+yx);
			$("#yixuantr").append("<span id='yixuantr2_"+id+"'>&nbsp;"+s2+"<a href='javascript:;'onclick=\"yixuancl('"+id+"','"+s2+"',"+s7+")\" style='color:#FF0'>[X]</a></span>");
		}
	}
