...
<div class="header">
  ...
  <div class="col-auto">
    <div class="log white cut_line">您好！<?php echo $_COOKIE["AdminUser"];?><span>|</span>所属角色：<?php
		...
		?><span>|</span>账号余额：<?php echo $yue;?>元<span>|</span><a href="../logouts.php">[退出]</a><span>|</span> <a href="/" target="_blank" id="site_homepage">站点首页</a><span>|</span>企业QQ：800023525 <img  style="CURSOR: pointer" onclick="javascript:window.open('http://b.qq.com/webc.htm?new=0&sid=800023525&eid=2188z8p8p8p8K8P8R8K8R&o=www.ruanwen.la&q=7&ref='+document.location, '_blank', 'height=544, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');"  border="0" SRC="http://im.bizapp.qq.com:8000/zx_qq.gif"></div>
