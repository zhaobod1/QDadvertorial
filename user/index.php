...
<div class="header">
	...
	<div class="col-auto">
		<div class="log white cut_line">您好！<?php echo $_COOKIE["VipUser"]; ?><span>|</span>所属角色：<?php
			...
			<a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $qq; ?>&site=在线客服&menu=yes"><img src="images/qqaol.png"
			                                                                                     alt="点我咨询"></a></div>
		<ul class="nav white" id="top_menu">
			<?php if ($_COOKIE["fg"] == 2) { ?>
				<li id="_M2" class="top_menu"><a href="javascript:_M(2,'tixian.php')" hidefocus="true"
				                                 style="outline:none;">申请提现</a></li>
				<li id="_M4" class="top_menu"><a href="javascript:_M(4,'../vip/index1.php')" hidefocus="true"
				                                 style="outline:none;">软文价格</a></li>
			<?php } else {
				?>
				<li id="_M1" class="top_menu"><a href="javascript:_M(1,'ruanwen_add.php')" hidefocus="true"
				                                 style="outline:none;">软文发布</a></li>
				<li id="_M3" class="top_menu"><a href="javascript:_M(3,'daixie_add.php')" hidefocus="true"
				                                 style="outline:none;">代写文章</a></li>
				<li id="_M4" class="top_menu"><a href="javascript:_M(4,'../vip/index1.php')" hidefocus="true"
				                                 style="outline:none;">软文价格</a></li>
				<?php
			}
			?>
			<li id="_M5" class="top_menu"><a href="javascript:_M(5,'info.php')" hidefocus="true" style="outline:none;">个人信息</a>
			</li>
			<li id="_M6" class="top_menu"><a href="javascript:_M(6,'work_add.php?titleID=ask')" hidefocus="true"
			                                 style="outline:none;">问题反馈</a></li>
			<?php if ($_COOKIE["fg"] <> 2) { ?>
				<li id="_M7" class="top_menu"><a href="javascript:_M(7,'chongzhi.php')" hidefocus="true"
				                                 style="outline:none;">在线充值</a></li><?php } ?>
			<li id="_M8" class="on top_menu"><a href="javascript:_M(8,'right.php')" hidefocus="true"
			                                    style="outline:none;">后台首页</a></li>
...
<div id="content">
	<div class="col-left left_menu">
		...
		<a href="javascript:;" id="openClose" style="outline-style: none; outline-color: invert; outline-width: medium;"
		   hideFocus="hidefocus" class="open" title="展开与关闭"><span class="hidden">展开</span></a></div>
	...
	<div class="col-auto mr8">
		...
		<div class="col-1">
			<div class="content" style="position:relative; overflow:hidden">
				<iframe name="right" id="rightMain" src="right.php" frameborder="false" scrolling="auto"
				        style="border:none; margin-bottom:10px" width="100%" height="auto"
