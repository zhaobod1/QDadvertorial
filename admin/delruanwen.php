...
<div id="main_frameid" class="pad-10 display" style="_margin-right:-12px;_width:98.9%;">
  <div class="col-2  col-auto" >
    ...
    <div class="content">
        <form id="form1" name="form1" method="post" action="saveruanwen.php?action=isdel" onsubmit="return check()" style="display:" >
        <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" id='step2'>
          ...
          <tr>
            ...
            <td align="left" bgcolor="#FFFFFF" style="padding:10px;"><textarea name="neirong" id="myEditor"><?php echo htmlspecialchars($rsN["content"]);?></textarea>
	     ...
	     <tr>
		  ...
		  <tr>
            <td height="30" bgcolor="#FFFFFF"><div align="center">申请删单</div></td>
            <td align="left" bgcolor="#FFFFFF" style="padding:10px;">
			<SELECT id="dyn" onchange=setprice(this.value) name="dyn">
			<OPTION value=0 <?php if($rsN["dyn"]==0) echo "selected";?>>不删</OPTION>
			<OPTION value=1 <?php if($rsN["dyn"]==1) echo "selected";?>>删除</OPTION>
			</SELECT></td>
          </tr>
		  <tr>
            <td height="30" bgcolor="#FFFFFF"><div align="center">删单原因</div></td>
            <td align="left" bgcolor="#FFFFFF" style="padding:10px;"><TEXTAREA rows="3" cols="87" id="dreason" name="dreason"><?php echo htmlspecialchars($rsN["dreason"]);?></TEXTAREA></td>
          </tr>
        </table>
