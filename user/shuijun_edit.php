    ...
    <div class="content">
        ...
        <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" id='step2'>
          ...
          <tr>
            ...
            <td align="left" bgcolor="#FFFFFF" style="padding:10px;"><textarea name="neirong"  style="width:100%;height:330px;visibility:visible;"><?php echo htmlspecialchars($rsN["content"]);?></textarea>
