...
<?php } ?>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><textarea name="content"  style="width:100%;height:230px;"><?php echo $rsN["content"];?></textarea></td>
    </tr>
	<tr bgcolor="#FFFFFF">
      <td width="17%" align="right">资源介绍： </td>
      <td><textarea name="neirong"  style="width:100%;height:330px;"><?php echo $rsN["neirong"];?></textarea></td>
    </tr>
	<tr bgcolor="#FFFFFF">
