...
<STYLE type=text/css>HTML {
	...
	.wycz_zh TABLE {
		BORDER-BOTTOM: #b0c5ee 1px solid;
		BORDER-LEFT: #b0c5ee 1px solid;
		HEIGHT: 45px;
		BORDER-TOP: #b0c5ee 1px solid;
		BORDER-RIGHT: #b0c5ee 1px solid
	}
...
<DIV style="_width: 98.9%; _margin-right: -12px" id=main_frameid class="pad-10 display">
	<DIV class="col-2  col-auto">
		<H6>在线充值</H6>
		<DIV class=content>
			<FORM name=alipayment onSubmit="return CheckForm();" action="../pay/alipayapi.php" method=post
			      target="_blank">
				<TABLE cellSpacing=1 cellPadding=5 width="100%" bgColor=#e2e2e2 style="font-size:13px">
					<TBODY>
					<TR>
						<TD bgColor=#ffffff height=35>
							<DIV align=center>充　　值</DIV>
						</TD>
					...
					<TR>
						...
						<TD bgColor=#ffffff width="88%" align=left>&nbsp;&nbsp;<?php echo $_COOKIE["VipUser"]; ?></TD>
					</TR>
					<TR>
						<TD bgColor=#ffffff height=35 width="12%">
							<DIV align=center>
								<DIV align=center>收 款 方</DIV>
							</DIV>
						</TD>
						<TD bgColor=#ffffff width="88%" align=left>&nbsp;&nbsp;<?php echo $seller_email; ?></TD>
					</TR>
					<INPUT size=30 name=WIDseller_email maxlength="200" value="<?php echo $seller_email; ?>"
					       type="hidden">
					...
					<TR>
						<TD bgColor=#ffffff height=35>
							<DIV align=center>充值金额</DIV>
						</TD>
						<TD bgColor=#ffffff align=left>&nbsp;
							<!--<INPUT maxLength=10 size=30 name=WIDtotal_fee onFocus="if(Number(this.value)==0){this.value='';}" value="0.01" style="width:113"/>&nbsp; <span>如：112.21</span>-->
							<INPUT value="<?php echo $_COOKIE["VipUser"]; ?>" type="hidden" name="VipUser"></TD>
					</TR>
					<TR>
						<TD bgColor=#ffffff height=35>&nbsp;</TD>
						<TD bgColor=#ffffff align=left>　<INPUT style="WIDTH: 80px; HEIGHT: 25px" id=button
						                                       value=" 开始支付 " type=submit name=button></TD>
					</TR>
					</TBODY>
				</TABLE>
			</FORM>
			...
			<DIV class=wycz_zh>
				<TABLE width="100%" style="font-size:13px">
					<TBODY>
					<TR>
						<TH id=kaihu_sm colSpan=4>其他支付方式：请在支付后通知客服查账！</TH>
					</TR>
					<TR>
						<TH width="18%">银行</TH>
						<TH width="17%">账户</TH>
					...
					?>
					<TR>
						<TH id=kaihu_sm colSpan=4>如需开票，需要额外加收8%的税点。</TH>
					</TR>
					</TBODY>
				</TABLE>
			</DIV>
...
<IFRAME id=main height=0 src="about:blank" frameBorder=0 width=0 name=main></IFRAME>
