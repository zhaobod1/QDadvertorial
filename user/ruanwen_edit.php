...
<div id="main_frameid" class="pad-10 display" style="_margin-right:-12px;_width:98.9%;">
  <div class="col-2  col-auto" >
    ...
    <div class="content">
        <form id="form1" name="form1" method="post" action="saveruanwen.php?action=redit" onsubmit="return check()" style="display:" >
        <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" id='step2'>
          <tr>
            ...
            <td width="88%" align="left" bgcolor="#FFFFFF" style="padding:10px;"><?php echo $rsN["title"];?>
              <input type="hidden" name="dingdan" id="dingdan"  value=""/>
              （标题字数尽量控制在18个汉字内！） </td>
          </tr>
          <tr>
            <td height="30" bgcolor="#FFFFFF"><div align="center">内    容</div></td>
            <td align="left" bgcolor="#FFFFFF" style="padding:10px;"><?php echo $rsN["content"];?><input type="submit" name="button" id="buttonsave" value=" 提 交 "  style="width:60px; height:25px;display:none" /></td>
          </tr>
	     <tr>
		  ...
		  <tr>
            ...
            <td align="left" bgcolor="#FFFFFF" style="padding:10px;"><SELECT id="flag" onchange=setflag(this.value) name="flag"> <OPTION value=1 >已收稿</OPTION> <OPTION value=2 <?php echo "selected";?>>已发布</OPTION></SELECT></td>
          </tr>
		  <tr>
