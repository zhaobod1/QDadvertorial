...
<table style="MARGIN-TOP: 5px; BORDER-COLLAPSE: collapse; MARGIN-BOTTOM: 5px; HEIGHT: 35px" border=1 cellSpacing=1 borderColor=#c9d3e9 cellPadding=0 width="98%" align=center>
  ...
  <tr>
    <td height="49" bgcolor="#FFFFFF"><form id="myform2" name="myform2" method="post" action="savetcbigclass.php?action=add&amp;titleID=<?php echo $titleID;?>" onsubmit="return CheckForm2();">
      <table class="tableBorder" width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF">
        <tr align="center" bgcolor="#F8F8F8" >
          <td width="50%" bgcolor="#F8F8F8">类型名称</td>
          <td width="25%" bgcolor="#F8F8F8">排序</td>
          <td width="25%" bgcolor="#F8F8F8">操 作</td>
        </tr>
        <tr align="center" bgcolor="#F8F8F8" >
          <td bgcolor="#FFFFFF"><input name="BigClass1" type="text" id="BigClass1" size="60" /></td>
    ...
    <td height="49" bgcolor="#FFFFFF"><table width="100%" height="49" border="0" cellpadding="0" cellspacing="1">
      <tr>
		...
		?>
			  ...
			  {
			  ?>
                <form id="myform" name="myform" method="post" action="savetcbigclass.php?action=edit&amp;titleID=<?php echo $titleID;?>&amp;ID=<?php echo $rs["ID"]?>" onsubmit="return CheckForm();">
                  <tr align="center" onmouseover="this.bgColor='#FBDFCC';" onmouseout="this.bgColor='#FFFFFF';" height=25>
                    <td align="center"><?php echo $i;?></td>
                    <td><input name="BigClass" type="text" id="BigClass" value="<?php echo $rs["BigClass"];?>" size="60" /></td>
                    <td width="19%" align="center"><input name="classidorder" type="text" id="classidorder" value="<?php echo $rs["paixu"];?>" size="4" /></td>
                    <td width="19%" align="center"><DIV class="alink" align=center><input type="submit" name="Submit" value="修改"/>
                      <a href="savecpbigclass.php?action=del&amp;titleID=<?php echo $titleID;?>&amp;ID=<?php echo $rs["ID"]?>">删除</a></div></td>
                  </tr>
                </form>
                <?php
				$i++;
