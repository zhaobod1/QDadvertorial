...
<div class="col-2  col-auto" >
    ...
    <form id="form1" name="form1" method="post" action="action.php?a=rwadd" onsubmit="return check()" style="display:" >
        ...
        <script type='text/javascript'>
	     ...
	     <tr>
         <td colspan="2"> <input name="totalmoney" type="hidden" id="totalmoney" style="border:0px;" value="0" readonly="readonly"/> <input type="hidden" id='yixuanhidden' name='yixuanhidden'/><input type="button" value="下一步" onclick="nextpage()" style="width:100px; height:30px; text-align:center; margin-top:5px; "/> 
		  </td>
         </tr>
      </form>
    <br />
...
<input type="button" value="上一步" onclick="perpage()" style="width:100px;height:30px; text-align:center;margin-top:5px;"/> <input type="button" value=" 提 交 " onclick="$('#buttonsave').click()"  style="width:100px;height:30px; text-align:center;margin-top:5px;"/>
</div>
...
function mt_search()
{
	$.get("search.php?a=mt_search",{"mc":$("#meiti_name").val(),"fl":$("#select").val(),"lj":$("#select2").val(),"xw":$("#select3").val()},function(data){
