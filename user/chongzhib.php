...
<FORM name=formbill onSubmit="return CheckForm();" action="../wechatPay/example/native.php" method=post>
<TABLE cellSpacing=1 cellPadding=5 width="100%" bgColor=#e2e2e2 style="font-size:13px">
  ...
  <TR>
    ...
    <TD bgColor=#ffffff align=left>&nbsp; <INPUT maxLength=10 size=30 name=v_amount onFocus="if(Number(this.value)==0){this.value='';}" value="100" style="width:113"/>&nbsp; <span>如：112，必须是整数</span>
