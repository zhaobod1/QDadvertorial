...
<TABLE cellSpacing=1 cellPadding=0 width="100%" bgColor=#e2e2e2>
  ...
  <TR>
    ...
    bgColor=#ffffff align=left><!--王庆路 去掉visibility:hidden--><textarea name="yaoqiu"  style="width:100%;height:330px;"><?php echo htmlspecialchars($rsN["content"]);?></textarea><!--王庆路 去掉visibility:hidden end-->
       </TD></TR>
  <TR>
    <TD bgColor=#ffffff height=30>
