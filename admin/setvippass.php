...
<div class="col-2  col-auto" >
	<h6>密码修改（会员：<b style='color:#2a8104'><?php echo $VipUser;?></b>）</h6>
	<div class="content">
    
	  <form id="form1" name="form1" method="post" action="savevip.php?action=pass&amp;ID=<?php echo $rs["ID"];?>" onsubmit="return check()">
  ...
  <TR>
    ...
    <TD bgcolor="#FFFFFF"><SPAN id=dcpassword class=f_red></SPAN>&nbsp; </TD></TR>
	      <tr>
	        ...
	        <td align="left" bgcolor="#FFFFFF"><input type="submit" name="button" id="button" value=" 修改密码 "/></td>
