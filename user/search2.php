...
<table  width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" id="searchtr" style="font-size:13px">
    ...
    while($rs=mysql_fetch_array($result))
    {
        ...
        ?>
        <TR>
            <td height="25" width="33" align="center"><input name="xz[]" type="checkbox" id="xz_<?php echo $rs["ID"];?>" value="<?php echo $rs["ID"]?>" onclick="sel(<?php echo $rs["ID"];?>,<?php echo $rs["ID"];?>,<?php echo $rs["headline_price"];?>,<?php echo $rsu["yue"];?>);" /></td>
