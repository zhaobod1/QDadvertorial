...
function mt_search()
{
	$.get("../user/huiyuan_search1.php?a=mt_search",{"mc":$("#meiti_name").val(),"cid":$("#class_id").val(),"skey":$("#skey").val(),"mh":$("#zhmh").val(),"diqu":$("#diqu").val(),"lurl":$("#linkurl").val(),"xwy":$("#xinwenyuan").val()},function(data){
...
{
	$.get("../user/huiyuan_search1.php?a=mt_search",{"fl":id},function(data){
...
{
	$.get("../user/huiyuan_search1.php?a=mt_search",{"jg":id},function(data){
...
{
	$.get("../user/huiyuan_search1.php?a=mt_searchall",{"jg":"all"},function(data){
...
{ 
	$.get("../user/huiyuan_search1.php?a=mt_searchall",{"xw":id},function(data){
...
{ 
	$.get("../user/huiyuan_search1.php?a=mt_searchall",{"lj":id},function(data){
...
{ 
	$.get("../user/huiyuan_search1.php?a=mt_searchall",{"dq":id},function(data){
...
{ 
	$.get("../user/huiyuan_search1.php?a=mt_searchall",{"zhmh":id},function(data){
