...
function wechat_search_name() {
	...
	if(name!=null){
		$.get("../admin/search2.php",{"name":name},function (data) {
			$("#s_wechat").html(data);
		});
	}
	else{
		$.get("../admin/search2.php",{"area":'all'},function (data) {
			$("#s_wechat").html(data);
		});
	}
}
...
function wc_search_area(area) {
	$.get("../admin/search2.php",{"area":area},function (data) {
		$("#s_wechat").html(data);
	});
}
function wc_search_media(media) {
	$.get("../admin/search2.php",{"media":media},function (data) {
		$("#s_wechat").html(data);
	});
}
function wc_search_headprice(price) {
	$.get("../admin/search2.php",{"headprice":price},function (data) {
		$("#s_wechat").html(data);
	});
}
function wc_search_fans(fans) {
	$.get("../admin/search2.php",{"fans":fans},function (data) {
		$("#s_wechat").html(data);
	});
}
function wc_search_fansauth(auth) {
	$.get("../admin/search2.php",{"auth":auth},function (data) {
		$("#s_wechat").html(data);
	});
}
function wc_search_wechatauth(auth) {
	$.get("../admin/search2.php",{"auth2":auth},function (data) {
		$("#s_wechat").html(data);
	});
}
function wc_search_viewrefer(num) {
	$.get("../admin/search2.php",{"view":num},function (data) {
		$("#s_wechat").html(data);
	});
}
/*王庆路 点击分类及微信查找 end*/
