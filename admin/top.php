...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="skin/images/frame/topbg.gif">
  <tr>
    ...
    <td width='80%' align="left" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>您好：<span class="red">
          <?php echo $_COOKIE["AdminUser"];?>
        </span>权限：<span class="red">
        <?php
		switch($_COOKIE["fg"])
		{
		 case "1":
		...
		?>
        </span>，欢迎使用郑州市新成机械设备厂内容管理系统！
          [<a href="../" target="_blank">网站主页</a>]
          [<a href="manageadmin.php" target="main">修改密码</a>]
    [<a href="logout.php" target="_top">注销退出</a>]&nbsp; </td>
      </tr>
      <tr>
        <td height="20">&nbsp;</td>
      </tr>
