...
<div id="main_frameid" class="pad-10 display" style="_margin-right:-12px;_width:98.9%;">
	<div class="col-2  col-auto">
		...
		<div class="content">
			<form id="form1" name="form1" method="post" action="saveruanwen.php?action=pub" onsubmit="return check()"
			      style="display:">
				<table width="100%" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" id='step2'>
					...
					<tr>
						...
						<td align="left" bgcolor="#FFFFFF" style="padding:10px;">
							...
							<?php } ?>
							<textarea name="neirong" style="width:100%;height:330px;visibility:hidden;"><?php echo htmlspecialchars($rsN["content"]); ?></textarea>
					...
					<tr>
						...
						<td align="left" bgcolor="#FFFFFF" style="padding-left:10px;"><font
								color="#FF0000"><b><?php echo $rsN[price]; ?></b></font>元
					...
					<tr>
						...
						<td align="left" bgcolor="#FFFFFF" style="padding:10px;"><SELECT id="flag"
						                                                                 onchange=setflag(this.value)
						                                                                 name="flag">
								<OPTION value=1>处理中</OPTION>
								<OPTION value=2 <?php echo "selected"; ?>>已发布</OPTION>
							</SELECT></td>
					</tr>
					<tr>
						<td height="30" bgcolor="#FFFFFF">
							<div align="center">发布网址</div>
						</td>
						<td align="left" bgcolor="#FFFFFF" style="padding:10px;"><input name="weburl" type="text"
						                                                                class="txt" id="weburl"
						                                                                value="<?php echo $rsN["weburl"]; ?>"
						                                                                size=100/></td>
					</tr>
				</table>
				<div align="center"><input name="totalmoney" type="hidden" id="totalmoney" style="border:0px;" value="0"
					...
					<!--input type="button" value="下一步 选择媒体" onclick="nextpage()" style="width:130px; height:30px;text-align:center;  margin-top:10px; "/><input type="button" value="上一步 选择媒体" onclick="perpage()" style="width:130px;height:30px; text-align:center;margin-top:3px;"/--><input
						type="button" value=" 提 交 " onclick="$('#buttonsave').click()"
