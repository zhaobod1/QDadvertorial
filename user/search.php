...
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" id="searchtr" style="font-size:13px">
	...
	<tr>
		...
		<th height="30" width="33" bgcolor="#CDD3EB">
			<div align="center"><strong>勾选</strong></div>
		</th>
		...
		<?php } elseif ($flag == 2) { ?>
			<th width="100" bgcolor="#CDD3EB">
				<div align="center"><strong>核心代理</strong></div>
			</th>
	...
	if (mysql_num_rows($result) == NULL) {
		...
		while ($rs = mysql_fetch_array($result)) {
			...
			<tr id='yixuna<?php echo $rs["ID"]; ?>'>
				...
				<td width="130">
					<div align="center"><a href='../zyinfo.php?ID=<?php echo $rs["ID"]; ?>'
					                       target="_blank"><?php echo $rs["medianame"]; ?></a></div>
					<input name="xz_mc_<?php echo $rs["ID"]; ?>" type="hidden" id="xz_mc_<?php echo $rs["ID"]; ?>"
					       value="<?php echo $rs["medianame"]; ?>"><span style="float:right"><a
				...
				<td width="100">
					<div align="center" style="color: rgb(255, 0, 0);"><b><?php echo $thePrice; ?></b></div>
				</td>
