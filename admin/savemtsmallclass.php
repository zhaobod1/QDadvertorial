...
else
{
  ...
  if(mysql_num_rows($result)==NULL)
  {
   ...
   echo "<script>alert('添加成功！');location.href='managemtsmallclass.php?titleID=".$titleID."';</script>";
  }
  else
  {
  ...
  mysql_select_db($dbname);
  $result=mysql_query($sql);
  echo "<script>alert('修改成功！');location.href='managemtsmallclass.php?titleID=".$titleID."';</script>";
  ...
  echo "<script>alert('删除成功！');location.href='managemtsmallclass.php?titleID=".$titleID."';</script>";
  break;
  }
}
?>