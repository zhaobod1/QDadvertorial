...
<div class="col-2  col-auto" >
	...
	<div class="content">
	  <form id="form1" name="form1" method="post" action="saveinfo.php" onsubmit="return check()">
		...
		<div width="120px" style="float:left;margin-left:13px;padding-top:3px;padding-bottom:5px;"><img src="<?php echo $rs["headpic"];?>" border="0" width="110" height="110"></div>
	      <tr>
	        <td width="12%" height="30" bgcolor="#FFFFFF"><div align="center">
	          <div align="center">会员名称：</div>
	          </div></td>
	        <td width="88%" align="left" bgcolor="#FFFFFF"><?php echo $_COOKIE["VipUser"];?></td>
          </tr>
	      <tr>
	        <td height="30" bgcolor="#FFFFFF"><div align="center">腾 讯 QQ：</div></td>
	      ...
	      <tr>
	        <td height="30" bgcolor="#FFFFFF"><div align="center">个人网站：</div></td>
	      ...
	      <tr>
	        <td height="30" bgcolor="#FFFFFF"><div align="center">联系邮箱：</div></td>
		  ...
		  <tr bgcolor="#FFFFFF">
		  <td height="30" bgcolor="#FFFFFF"><div align="center">个人头像：</div></td>
