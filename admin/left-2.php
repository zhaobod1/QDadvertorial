...
<ul id="LM1">
<a onClick="javascript:ShowFLT(1)" href="javascript:_TMP(0,5,'viplist.php');"><h3 class="f14"><span class="switchs cu on" title="展开与收缩"></span>会员管理</h3></a>
...
<li id="_MP60" class="sub_menu"><a href="javascript:_MP(60,'vipadd.php');" hidefocus="true" style="outline:none;">会员添加</a></li>
</ul>
<ul id="LM2" style="DISPLAY: none">
<a onClick="javascript:ShowFLT(2)" href="javascript:_TMP(1,56,'meiti_list.php');"><h3 class="f14"><span class="switchs cu on" title="展开与收缩"></span>新闻投放</h3></a>
...
<li id="_MP56" class="sub_menu"><a href="javascript:_MP(56,'meiti_list.php');" hidefocus="true" style="outline:none;">媒体列表</a></li>
</ul>
<ul id="LM3" style="DISPLAY: none">
<a onClick="javascript:ShowFLT(3)" href="javascript:_TMP(2,9,'daixie.php');"><h3 class="f14"><span class="switchs cu on" title="展开与收缩"></span>代写管理</h3></a>
...
<a onClick="javascript:ShowFLT(11)" href="javascript:_TMP(3,33,'wyx_list.php');"><h3 class="f14"><span class="switchs cu on" title="展开与收缩"></span>微营销</h3></a>
...
<a onClick="javascript:ShowFLT(12)" href="javascript:_TMP(4,36,'shequ_list.php');"><h3 class="f14"><span class="switchs cu on" title="展开与收缩"></span>社区管理</h3></a>
...
<a onClick="javascript:ShowFLT(13)" href="javascript:_TMP(5,39,'huiyuan_list.php');"><h3 class="f14"><span class="switchs cu on" title="展开与收缩"></span>关键词营销</h3></a>
...
<a onClick="javascript:ShowFLT(14)" href="javascript:_TMP(6,42,'shuijun_list.php');"><h3 class="f14"><span class="switchs cu on" title="展开与收缩"></span>硬广投放</h3></a>
...
<a onClick="javascript:ShowFLT(15)" href="javascript:_TMP(7,45,'menhuhz_list.php');"><h3 class="f14"><span class="switchs cu on" title="展开与收缩"></span>门户合作</h3></a>
...
<a onClick="javascript:ShowFLT(16)" href="javascript:_TMP(8,48,'huodong_list.php');"><h3 class="f14"><span class="switchs cu on" title="展开与收缩"></span>活动</h3></a>
...
<a onClick="javascript:ShowFLT(17)" href="javascript:_TMP(9,51,'qunfa_list.php');"><h3 class="f14"><span class="switchs cu on" title="展开与收缩"></span>群发</h3></a>
...
<a onClick="javascript:ShowFLT(18)" href="javascript:_TMP(10,54,'appkf_list.php');"><h3 class="f14"><span class="switchs cu on" title="展开与收缩"></span>其他服务</h3></a>
...
<a onClick="javascript:ShowFLT(5)" href="javascript:_TMP(11,13,'work_list.php?titleID=ask');"><h3 class="f14"><span class="switchs cu on" title="展开与收缩"></span>反馈管理</h3></a>
