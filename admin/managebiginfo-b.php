...
if($key=="")
{
$sql="select * from ".$titleID."_info order by ID desc limit ".($List_Num*($Page-1)).",".$List_Num."";
}
else
{
$sql="select * from ".$titleID."_info where ".$skey." like '%".$key."%' order by ID desc limit ".($List_Num*($Page-1)).",".$List_Num."";
}
			  ...
			  ?>
                  <tr align="center" >
                    <td colspan="7" align="right" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="2">
					  ...
					  {
					  $Prv=$Page-1;
					  echo "<a href=?skey=".$skey."&key=".$key."&titleID=".$titleID.">首页</a>&nbsp;&nbsp;";
					  echo "<a href=?Page=".$Prv."&skey=".$skey."&key=".$key."&titleID=".$titleID.">上一页</a>&nbsp;&nbsp;";
					  }
					  else
					  {
					   echo "首页&nbsp;&nbsp;";
					...
					echo $str;
					  ...
					  $NtPage=$Page+1;
					  $EdPage=$CountPage;
					  echo "<a href=?Page=".$NtPage."&skey=".$skey."&key=".$key."&titleID=".$titleID.">下一页</a>&nbsp;&nbsp;";
					  echo "<a href=?Page=".$EdPage."&skey=".$skey."&key=".$key."&titleID=".$titleID.">尾页</a>&nbsp;&nbsp;";
					  }
					  else
					  {
					   echo "下一页&nbsp;&nbsp;";
