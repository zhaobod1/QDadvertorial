		...
		?>
                <table class="tableBorder" width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
                  <tr align="center" bgcolor="#F8F8F8" >
					...
					<td width="50%" bgcolor="#FFFFFF">问题内容</td>
			  ...
			  ?>
                  <tr>
                    ...
                    <td align="center" bgcolor="#FFFFFF"><a href="editworkinfo.php?ID=<?php echo $rs["ID"];?>&amp;class_id=<?php echo $rs["class_id"];?>&amp;titleID=<?php echo $titleID;?>">修改</a></td>
