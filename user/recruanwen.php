        ...
        <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" id='step2'>
	     ...
	     <tr>
		  ...
		  <tr>
            ...
            <td align="left" bgcolor="#FFFFFF" style="padding:10px;"><SELECT id="flag" onchange=setprice(this.value) name="flag"> <OPTION selected value=0 >待收稿</OPTION> <OPTION value=1 <?php echo "selected";?>>已收稿</OPTION></SELECT></td>
          </tr>
        </table>
