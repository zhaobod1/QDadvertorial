...
<form id="form1" name="form1" method="post"
      action="savecpbiginfo.php?action=edit&ID=<?php echo $ID; ?>&titleID=<?php echo $titleID; ?>"
	...
	<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#e2e2e2"
		...
		<tr bgcolor="#EEF4EA">
			<td colspan="2" align="center" background="skin/images/frame/wbg.gif" class='title'><span
					class="sitemu"><strong>修改信息内容</strong></span></td>
		</tr>
		<tr bgcolor="#FFFFFF">
			...
			<td><select name="class_id" size="1" id="class_id">
					...
					while ($rs = mysql_fetch_array($result)) {
						?>
						<option value="<?php echo $rs["ID"]; ?>" <?php if ($rs["ID"] == $class_id) {
							echo "selected";
		...
		<tr bgcolor="#FFFFFF">
			...
			<td width="83%"><input name="title" type="text" id="title" value="<?php echo $rsN["title"]; ?>" size="60"/>
			</td>
		</tr>
		<tr bgcolor="#FFFFFF">
		...
		<tr bgcolor="#FFFFFF">
			...
			<td><input name="propic" type="text" class="webInput" id="propic3" value="<?php echo $rsN["propic"]; ?>"
			           size="60"/>
				<input type="button" name="Submit4" value="上传图片"
				       onclick="window.open('upfile_indexpic.php?setform=form1&amp;setpic=propic&amp;setress=propic','','status=no,scrollbars=no,top=20,left=110,width=420,height=165')"/>
			</td>
		</tr>
		<!--tr bgcolor="#FFFFFF">
      ...
      <td><label>
		...
		<tr bgcolor="#FFFFFF">
			...
			<td><textarea name="content"
			              style="width:100%;height:330px;visibility:hidden;"><?php echo htmlspecialchars($rsN["content"]); ?></textarea>
			</td>
		</tr>
		<tr bgcolor="#FFFFFF">
