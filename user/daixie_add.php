				...
				<TABLE cellSpacing=1 cellPadding=0 width="100%" bgColor=#e2e2e2>
					...
					<TR>
						...
						<TD
							...
							bgColor=#ffffff width="88%" align=left><INPUT id="biaoti" lang=require class="form-control"
						                                                  size=100 name="biaoti">（标题字数控制在20个汉字以内为宜！）
						</TD>
					</TR>
					<TR>
						<TD bgColor=#ffffff height=30>
							<DIV align=center>要求</DIV>
						</TD>
						<TD
							style="PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 10px"
							bgColor=#ffffff align=left>
		<textarea name="yaoqiu" style="width:100%;height:330px;visibility: hidden">1、推广对象：&lt;BR /&gt;
2、文章体裁：&lt;BR /&gt;
3、文章标题：&lt;BR /&gt;
4、宣传要点：&lt;BR /&gt;
5、其他要求：&lt;BR /&gt;
5、软文案例：&lt;br /&gt;若能提供一篇您认为不错的软文链接给我们，对我们的写作方向很有参考作用，写出的文章也能比较达到您预期的要求。&lt;BR /&gt;</textarea>
					...
					<TR>
						<TD bgColor=#ffffff height=30>
							<DIV align=center>参考示例</DIV>
						</TD>
						<TD style="PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 10px"
						    bgColor=#ffffff align=left>1、推广对象：一起飞（www.yiqifei.com），正文里添加一处网址；<BR>2、文章体裁：采访型/评论型/故事型/自由型（请选择1种），字数1000以上，要求原创；<BR>3、文章标题：含关键词“特价机票”；<BR>4、宣传要点：一起飞机票网，特价机票2折起，可预订全球200个国家机票，方便又实惠；<BR>5、若有其他要求请写清楚详细，不满意可以重新修改。<BR>6、若能提供一篇您认为不错的软文链接给我们，对我们的写作方向很有参考作用，写出的文章也能比较达到您预期的要求。
						</TD>
					</TR>
					<TR>
						<TD bgColor=#ffffff height=30>
							<DIV align=center>篇数</DIV>
						</TD>
						<TD style="PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 10px"
						    bgColor=#ffffff align=left><SELECT id="pianshu" lang=require onchange=setprice(this.value)
						                                       name="pianshu">
								<OPTION selected value=0>请选择</OPTION>
								<OPTION value=1>代写1篇50元</OPTION>
								<OPTION value=2>代写2篇100元</OPTION>
								<OPTION value=3>代写3篇150元</OPTION>
								<OPTION value=4>代写4篇200元</OPTION>
								<OPTION value=5>代写5篇250元</OPTION>
								<OPTION value=6>代写6篇300元</OPTION>
								<OPTION value=7>代写7篇350元</OPTION>
								<OPTION value=8>代写8篇400元</OPTION>
								<OPTION value=9>代写9篇450元</OPTION>
								<OPTION value=10>代写10篇500元</OPTION>
							</SELECT></TD>
					</TR>
					<TR>
						<TD bgColor=#ffffff height=30>
						...
						<TD style="PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 10px"
						    bgColor=#ffffff align=left><INPUT style="COLOR: rgb(255,0,0)" id="jiage"
						                                      class=txt value=50 readOnly size=8 name="jiage"> 元 <SPAN
								id="ye"></SPAN><!--INPUT
      id="dingdan" value="201308121116273426" type="hidden" name="dingdan"--><INPUT
								id="yuer" value="<?php echo $yue; ?>" type="hidden" name="yuer"></TD>
					</TR>
					<TR>
						<TD bgColor=#ffffff height=30>&nbsp;</TD>
						<TD bgColor=#ffffff align=left><INPUT style="WIDTH: 60px; HEIGHT: 25px" id="button"
						                                      value=" 提 交 " type=submit disabled name="button">
						</TD>
					</TR>
					</TBODY>
				</TABLE>
